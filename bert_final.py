...
flags.DEFINE_string("image_feature_dir", '/data/tmh/EEdata/picture_resnet',
...
def create_model(bert_config, is_training, input_ids, input_mask,
    ...
    #print(output_layer)
    #print('******************')
    #output_layer = output_layer + multihead_attention(output_layer, image_features, is_training = is_training, num_units = 768, num_heads = 8, dropout_rate = 0.2)
